 ...
 * speaks the instruction. Reports back whether the element was located.
 */
object StepExecutor {

    /** TODO: Day 10 — resolve element, show dot, speak instruction. */
    fun execute(step: Step): Boolean {
        // TODO
        return false
    }
}
